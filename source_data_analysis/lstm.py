...
###定义拟合LSTM模型的函数，输入日期，时间，是否节假日
def fit_lstm(data_prepare, n_neurons=50, n_batch=16, n_epoch=100, loss='mae', optimizer='adam', repeats=1):
...
if __name__ == '__main__':
    ...
    # 参考：https://zhuanlan.zhihu.com/p/191211602?utm_source=wechat_session&utm_medium=social&utm_oi=969524886629158912&utm_campaign=shareopn