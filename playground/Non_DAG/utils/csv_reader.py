...
class CSVReader(object):
    def __init__(self, filename):
        ...
        for i in range(len(df)):
            ...
            task_configs.append(TaskConfig(task_id, instances_num, cpu, memory, disk, duration, priority))
            job_submit_time_map[job_id] = submit_time
            # print("csv reader", job_id, submit_time)
    ...
    def generate(self, offset, number):
        ...
        for job_config in ret:
            # print(job_config.id, len(job_config.task_configs))
